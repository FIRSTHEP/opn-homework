        ...
        <Row>
          ...
          <Col span={12}>
            <Button
              ...
              style={{ ...buttonStyle, height: '50px', width: '50px', float: 'right' }}
              onClick={onClose}
            />
          </Col>
        </Row>
            ...
            <div key={index} className="cart-item" style={{ marginBottom: index === cartItems.length - 1 ? '40px' : '5px' }}>
              ...
              <Row justify="end" gutter={[16, 16]}>
                <Col xs={5} sm={5} md={5} lg={5} xl={5}>
                  <Button icon={<MinusOutlined style={{ fontSize: '14px' }} />} size="large" onClick={() => decreaseQty(index)} style={buttonStyle} />
                </Col>
                <Col xs={14} sm={14} md={14} lg={14} xl={14} style={{ textAlign: 'center', ...buttonStyle, fontSize: '1.2em', fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '6px' }}>
                  <span>{item.qty}</span>
                </Col>
                <Col xs={5} sm={5} md={5} lg={5} xl={5}>
                  <Button icon={<PlusOutlined style={{ fontSize: '14px' }} />} size="large" onClick={() => increaseQty(index)} style={buttonStyle} />
                </Col>
              </Row>
              <br />
            </div>
